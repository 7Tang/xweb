...
<template>
  <div class="pagination-container">
    ...
    <div class="page-num"><input type="text" class="page-input" v-model="pageNum" @blur="setCurrent(pageNum)">/{{ page }}页</div>
    </template>
  </div>
</template>
